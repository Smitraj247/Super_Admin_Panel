...
const COLOR_MAP = {
  green: {
    ...
    glow: "hover:shadow-[0_10px_30px_-10px_rgba(16,185,129,0.6)] hover:scale-[1.03] hover:opacity-100",
  },
  orange: {
  ...
  blue: {
    ...
    glow: "hover:shadow-[0_10px_30px_-10px_rgba(59,130,246,0.35)] hover:scale-[1.03] hover:opacity-100",
  },
  red: {
...
const ActionButton = forwardRef(
  (
    { icon, label, subtitle, color = "blue", onClick, path, disabled = false },
    ref,
  ) => {
