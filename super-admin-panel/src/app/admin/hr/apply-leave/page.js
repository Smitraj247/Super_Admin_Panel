  ...
  return (  
    <>
      <h2 className="text-2xl font-bold">
        <span className="text-xl sm:text-3xl font-bold bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
          Leave Management
        </span>
      </h2>
                  ...
                  <tbody>
                    {userLeaves.map((leave) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <span
                            className={`px-3 py-1 text-sm rounded-full font-semibold ${statusColor(
                              leave.status,
                            )}`}
                          >
                            {leave.status}
